...
3. Changes (under 150) -- `.rulesync/docs/git/pr-sections/changes.md`
4. Behavior Parity (under 70) -- `.rulesync/docs/git/pr-sections/behavior-parity.md`
5. Downstream Impact (under 60), *conditional* -- `.rulesync/docs/git/pr-sections/downstream-impact.md`
6. Testing (under 40) -- `.rulesync/docs/git/pr-sections/testing.md`
7. Validation (under 50) -- `.rulesync/docs/git/pr-sections/validation.md`
8. Screenshots (under 20), *conditional* -- `.rulesync/docs/git/pr-sections/screenshots.md`
...
- **Development URL** -- included when the restructured code renders or runs in the app, so a reviewer can check parity against production themselves.
- **Storybook Preview** -- on a visual restructure the Chromatic diff is the parity evidence, so this and Behavior Parity reinforce each other.
...
`.rulesync/docs/git/pr-examples/refactor.md`
